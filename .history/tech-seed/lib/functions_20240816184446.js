...
const getFiles = async () => {
  const response = await fetch(`http://192.168.1.104:8000/api/files/`, {
    method: "GET",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
...
const addfile = (name) => {
  return fetch(`http://192.168.1.104:8000/api/files`, {
    method: "POST",
    headers: {
      accept: "application/json",
      Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
...
const getOnefile = async (id) => {
  const res = await fetch(`http://192.168.1.104:8000/api/files/${id}`, {
    method: "GET",
    headers: {
      accept: "application/json",
      Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
...
const updateOneFile = async (id, name) => {
  const response = await fetch(`http://192.168.1.104:8000/api/files/${id}`, {
    method: "PUT",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
      Accept: "application/json",
