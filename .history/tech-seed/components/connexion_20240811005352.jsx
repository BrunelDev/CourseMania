  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <span className={` py-2 px-3 text-center rounded-md w-fit h-fit z-50`}>
          okokok
        </span>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[800px]">
        <div className="h-[600px] w-[600px] grid gap-4 py-4">
          {/* Ajout  des elements de la pages connexion */}
          <main className="flex w-full space-x-2 justify-center items-center">
            <div className="relative flex-1 items-center justify-center bg-[url('placeholder1.png')] bg-no-repeat bg-center bg-[length:500px_550px] h-full w-[500px] lg:flex">
              ...
              <div
                ...
                style={{
                  background:
                    "ar-gradient(152.92deg, rgba(192, 132, 252, 0.2) 4.54%, rgba(232, 121, 249, 0.26) 34.2%, rgba(192, 132, 252, 0.1) 77.55%)",
                  filter: "blur(118px)",
                }}
              ></div>
            </div>
