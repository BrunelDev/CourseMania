...
export default function Navbar() {
  const [homeIsSelected, homeIsSelected] = useState(true);
  const [aboutusIsSelected, aboutusIsSelected] = useState(false);
  const [courseIsSelected, courseIsSelected] = useState(false);
  const [aboutUsIsSelected, aboutUsIsSelected] = useState(false);
