      ...
      <DialogContent className="sm:max-w-[800px]">
        <div className="h-[500px] grid gap-4 py-4">
          ...
          <main className="flex w-full justify-center items-center">
            <div className="relative flex-1 hidden items-center justify-center bg-[url('placeholder1.png')] bg-no-repeat bg-center bg-[length:500px_550px] lg:flex">
              <div className="relative z-10 w-full max-w-md">
                <img src="lego.png" alt="" className="w-40 h-40" />
                <div className=" mt-16 -space-y-2 ml-28">
                  <h3 className="text-white text-3xl font-bold -mt-7">
                    Start growing your business quickly
                  </h3>{" "}
                  <br />
                  <div className="flex items-center -space-x-2  mt-80">
                    <img
