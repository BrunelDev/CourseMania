...
export default function Filter({ targetList }) {
  const Onglet = ({ children, title }) => {
    return (
      <div className="py-3 border-t border-t-gray-100 ">
  ...
  return (
    <div className="w-fit h-fit bg-white shadow-md flex flex-col justify-center items-center">
      <Onglet title={"Notes"}>
