  ...
  return (
    <div className="About">
      ...
      <div className="About_us">
        ...
        <p className="text1">
          <span className="week">
            <span className="text-[#FF9B26;]">WEEKEND UX </span> Providing The{" "}
            <br />
          ...
          <br /> <br />
          <br />
          Design Academy in Delhi involved in User Experience and User <br />{" "}
          Interface Training and Consulting. It was started in 2023 <br />
          and passionate towards User Interface Design/ User Experience Design,
          Human Computer <br /> Interaction Design. Humanoid is gushing <br />
          towards competence to acquire knowledge and <br /> have a wide
          understanding towards the sphere through the foremost courses <br />
          in the area of UI/UX Design, by strengthening up your skills, for your
          golden future <br />
      ...
      <div className="feature">
        <img src="" alt="" />
        <div className="text2">
          <h3 className="text-lg font-bold ml-18 mt-[-15px] ">Feature</h3>
          <br />
          <p className=" text-s">
            ...
            <span className="">
              ...
              minds of our students abouttheir goals, while making them
              consistent <br />
              in their ambitions and pushing them to be confident <br />
              for their journey towards the course of time.You will <br />
              <br />
              <br />
              i find every little thing on the nternet in just a click of hand,
              but here we admire
              <br />
              i that without knowledge and practice the
              <br />
              i internet may even also fail you in your life. <br />
              <br />
              <br />
              <button className="learn mt-[-28px] ml[-400px]">
                Learn More
              </button>
            </span>
          </p>
      ...
      <div className="text3">
        <span className="Our">Our Benefics</span>
        <br />
        <span className="desc">
