      ...
      <div className="flex w-full flex-row">
        <div className="h-full w-1/5">
          <div className="w-1/5 fixed top-0 left-0 h-full bg-white text- black border-r">
            ...
            <nav className="my-8 w-full flex flex-col justify-center items-center">
              <a
                href="#"
                className={`flex items-center space-x-2 py-4 w-full hover:bg-[#e5e5e5] duration-300 pl-3  ${
