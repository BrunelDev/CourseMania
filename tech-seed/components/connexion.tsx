...
export function Connexion() {
  return (
    <Dialog >
      ...
      <DialogContent className="sm:max-w-[8000px]">
        <DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          {/* Ajout  des elements de la pages connexion */}
        <main className="w-full flex -ml-40">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-[url('placeholder1.png')] bg-no-repeat bg-center bg-[length:500px_550px] ml-80 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <img src="" className="mt-2.5" width={150} />
                    <div className=" mt-16 -space-y-2 ml-28">
                        <h3 className="text-white text-3xl font-bold -mt-7">Start growing your business quickly</h3> <br />
                ...
                <div
                    ...
                    style={{
                        background: "ar-gradient(152.92deg, rgba(192, 132, 252, 0.2) 4.54%, rgba(232, 121, 249, 0.26) 34.2%, rgba(192, 132, 252, 0.1) 77.55%)", filter: "blur(118px)"
                    }}
                >
