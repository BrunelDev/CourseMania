  ...
  return (
    <main className="flex flex-col items-center bg-white min-h-screen">
      ...
      <div className="bg-white p-8 shadow-md rounded-lg w-full max-w-lg">
        ...
        <h3 className="text-2xl font-semibold text-center mb-6">Editez votre profile</h3>
        
        <div className="space-y-4">
          <div>
            <label htmlFor="first-name" className="block text-gray-600 text-sm font-medium mb-2">Nom:</label>
            <input
          ...
          <div>
            <label htmlFor="last-name" className="block text-gray-600 text-sm font-medium mb-2">Prénom:</label>
            <input
              className="w-full px-3 py-2 border-b border-gray-300 focus:outline-none focus:ring-0 focus:border-black"
              type="text"
              id="last-name"
          ...
          <div>
            <label htmlFor="language-select" className="block text-gray-600 text-sm font-medium mb-2">Langue:</label>
            <select
              name="language"
              id="language-select"
              className="w-full px-3 py-2 border-b border-gray-300 focus:outline-none focus:ring-0 focus:border-black"
